...
class LandlordRoutes:
    ...
    LANDLORDAPIBILLINGPAYMENTS = "/landlord/{landlordUuid}/api/tenants/{tenantId}/receipts/{billNo}/payments"
    LANDLORDAPIBILLINGPAYMENT = "/landlord/{landlordUuid}/api/tenants/{tenantId}/receipts/{billNo}/payments/{paymentId}"
...
class LandlordNames:
    ...
    APIGETPAYMENTS = "api_get_payments"
    APICREATEPAYMENT = "api_create_payment"
    APIUPDATEPAYMENTENTRY = "api_update_payment_entry"
    APIDELETEPAYMENTENTRY = "api_delete_payment_entry"
